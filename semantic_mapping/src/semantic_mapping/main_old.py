...
This is the old main file for the semantic system. If consistency checking is ever needed, 
this could act as a guide for implementing that system. However, Yolov8 has object tracking,
