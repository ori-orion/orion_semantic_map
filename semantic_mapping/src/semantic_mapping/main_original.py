...
def setup_system():
    ...
    ontology_tree = Ontology.read_file(
    ...
    human_manager = CollectionManager(
        types=human_types,
        service_name="humans",
        memory_manager=mem_manager
    );

    human_observation_types = TypesCollection(
    ...
    object_visualisation_manager = RvizVisualisationManager(
    ...
    def num_observation_threshold_query_callback(query_dict, metadata):
    ...
    observation_types = TypesCollection(
    ...
    observation_manager = ConsistencyChecker(
