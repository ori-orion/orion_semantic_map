...
The new perception system is writing everything directly into the database. Thus we
do not need to deal with looking for the perception messages. Instead this is just
the ROS entrypoint for the rest of the system. 
"""
